...
var range = function(x, y) {
  ...
  if ((x === undefined && y === undefined) || (x === y) || (x + 1 === y) || (x - 1 === y)) {
    return [];
  }
...
var exponent = function(base, exp) {
  ...
  // console.log(1 / (base * base * base));
  // return exp > 0 ? base * exponent(base, exp - 1) : (1 / (base * exponent(base, -exp - 1)).toFixed);
